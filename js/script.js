...
const carRed = {
    ...
    move: function() {
        /* увеличение текущей скорости на полученное ускорение */
        this.speed += getAcceleration();
        /* увелечение проуденного пути на текущуб скорость */
        this.dist += this.speed;
        this.img.style.left = this.dist + 'px';
    }
}
// описание объекта зеленого автомобиля
const carGreen = {
    /* name */
    name: 'зеленый лук',
    img: carGreenDiv,
...
// описание объекта синего автомобиля
const carBlue = {
    /* name */
    name: 'синяк',
    img: carBlueDiv,
...
// описание объекта желтого автомобиля
const carYellow = {
    /* name */
    name: 'желтуха',
    img: carYellowDiv,
...
let riceLoop = setInterval( () => {
    ...
    if (maxDist >= finish) {
        ...
        carBlue.move();
        carYellow.move();
        /* перечислите остальные автомобили */
    }
}, 7);